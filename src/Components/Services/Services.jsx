...
export default function Services() {
    ...
    // Render component
    return (
        <div className='flex-wrap sm:flex-nowrap flex items-center justify-around bg-white mt-10'>
            {/* Duyệt qua mảng dịch vụ và render component Coldesign cho mỗi dịch vụ */}
            {service.map((item) => {
                return (
